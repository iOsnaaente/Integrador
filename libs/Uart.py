...
class UART( Serial ):
    ...
    def __init__ ( self, COMP : str, baudrate : int = 115200, timeout : int = 1, *args, **kwargs ):
        try: 
            super().__init__( COMP, baudrate = baudrate, timeout = timeout, parity = PARITY_ODD )
            self.seriais_available.append( COMP )  
            self.BAUDS     = baudrate
